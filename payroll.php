                                    ...
                                    <div class="clearfix">
                                        <div class="float-left">
                                            <div class="text-center">
                                                <button type="button" class="btn btn-xl text-center bg-warning rounded-circle "><h1>LT</h1></button>
                                            </div>
                                            <small>
                                            <ul style="list-style-type:none;">
                                                <li>Lorem Technologies,</li>
                                                <li>6547 Lorem Ipsum Lane,</li>
                                                <li>Dolor, sit amet, 174852</li>
                                            </ul>
                                            </small>
                                        </div>
                                        <div class="float-right mt-4">
                                            <h5>Payslip #<?php echo rand(44444,99999) ?></h5>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="container">
                                                <ul class="list-group">
                                                    ...
                                                    <li class="list-group-item">Basic Salary <span class="float-right">$ <?php echo floor($row["salary"] * 0.25 ); ?></span></li>
                                                    <li class="list-group-item">H.R.A <span class="float-right">$ <?php echo floor($row["salary"] * 0.35 ); ?></span></li>
                                                    ...
                                                    <li class="list-group-item">Other Allowance <span class="float-right">$ <?php echo floor($row["salary"] * 0.20 ); ?></span></li>
                                            ...
                                            <div class="container mt-3">
                                                <small>
                                                    <ul class="list-group">
                                                        ...
                                                        <li class="list-group-item">PF (Self) <span class="float-right">$ <?php echo floor($row["salary"] * 0.02 ); ?></span></li>
                                                        <li class="list-group-item">PF (Company) <span class="float-right">$ <?php echo floor($row["salary"] * 0.02 ); ?></span></li>
                                                        <li class="list-group-item">PT <span class="float-right">$ <?php echo floor($row["salary"] * 0.005 ); ?></span></li>
                                                        <li class="list-group-item"><b>Total Deductions </b><span class="float-right"><b>$ <?php echo floor($row["salary"] * 0.045 ); ?></b></span></li>
                                                    </ul>
                                                </small>
                                            </div>
                                            <div class="container mt-4">
                                                <h3>Net Salary : $ <?php echo floor(($row["salary"])-($row["salary"] * 0.045 )); ?> </h3>
                                            </div>
                                        </div>
                                    </div>
